...
{
  "$end", "error", "$undefined", "TIPO", "ID", "VIRGULA", "PONTO_VIRGULA",
  "$accept", "programa", "declaracao", "@1", "lista_ids", 0
};
#endif
...
#line 55 "decl.y"
  ...
  case 5:
#line 58 "decl.y"
    { current_type = (yyvsp[(1) - (1)].str); ;}
    break;

  case 6:
#line 58 "decl.y"
    { free((yyvsp[(1) - (4)].str)); current_type = NULL; ;}
    break;

  case 7:
#line 61 "decl.y"
    { declare_var(current_type, (yyvsp[(1) - (1)].str)); ;}
    break;

  case 8:
#line 62 "decl.y"
    { declare_var(current_type, (yyvsp[(3) - (3)].str)); ;}
    break;


/* Line 1267 of yacc.c.  */
#line 1379 "decl.tab.c"
      default: break;
    }
